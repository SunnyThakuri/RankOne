  ...
  return (
    <>
      <div className="logodesignService bg-[#141414] -mt-20">
          ...
          <div className="left_side xl:ml-[60px] lg:ml-[40px] 
           xl:mr-[650px] lg:mr-[480px] 2xl:mr-[550px] ">
            ...
            <motion.div
              ...
              <p className='text-[#B2AFAF] text-[18px] 2xl:w-[569px] xl:w-[459px] lg:w-[359px]'>“DZ has been instrumental in not only growing our brand in the US, but has also increased our product and brand awareness within the Western Hemisphere. Not only did we gain a new, user-friendly website; Spider Mower USA gained a valuable team of dedicated digital-marketing, business growth professionals by partnering with Designzillas.”</p>
        ...
        {/* --------------------BUILD AUTHENTIC---------------- */}
        <div ref={authenticRef} className="Build_Authentic lg:flex lg:mt-40 mt-[350px] xl:mx-[80px]  xl:mb-[200px] ">
          ...
          <div className="right_side 2xl:ml-[650px] xl:ml-[550px] lg:ml-[450px] mt-[40px] font-Outfit">
            ...
            >
              <h1 className='text-white 2xl:text-[50px] md:text-[40px] text-[33px] font-bold font-Outfit lg:text-left text-center '>Build Authentic</h1>
              <h1 className='text-white 2xl:text-[50px] md:text-[40px] text-[33px] font-bold font-Outfit md:-mt-5 -mt-3 lg:text-left text-center '>Audience Connections</h1>
            </motion.div>
            ...
            <motion.p
              ...
              animate={authenticInView ? { y: 0, opacity: 1 } : {}}
              transition={{ duration: 1, delay: 0.3, ease: 'easeOut' }}
              className='text-[#B2AFAF] mt-5 lg:text-left text-center lg:mx-0 md:mx-[50px] sm:mx-[25px] mx-5'>With a clear vision in mind, our expert team brings your content ideas to life. Our talented writers and creatives collaborate closely with you to understand your brand’s unique voice and transform it into compelling content.
            </motion.p>
            ...
            <motion.p
              ...
              className='text-[#B2AFAF] mt-5 lg:text-left text-center lg:mx-0 mx-5 '>From ideation and creation to editing and publication, we work alongside you to develop engaging content experiences that resonate with your target audience. Through storytelling, personalization and targeted distribution, we ensure that
        ...
        {/* ------------------USERPHOTO------------ */}
        <div ref={readyRef} className="user_info bg-white xl:pl-[140px] xl:pr-[80px] xl:px-[70px] px-[20px] pt-10 xl:mt-28 sm:mt-[300px] mt-[100px] pb-[100px]">

          <div className="about lg:flex justify-between">
            <div className=" hidden lg:block left_side  ">
              <img className='2xl:w-[528px] h-[791px] xl:w-[800px] lg:w-[800px] w-[1500px]' src={serviceuserimg} alt="" />
            </div>

            <div className="right_side lg:w-[643px] h-[357px] xl:pl-[50px] 2xl:pt-[250px] lg:pt-[200px]  sm:pt-12  font-Outfit ">
              <motion.div
                initial={{ y: 30, opacity: 0 }}
                animate={readyInView ? { y: 0, opacity: 1.2 } : {}}
                transition={{ duration: 1, delay: 0.2, ease: 'easeOut' }}
              >
                <h1 className='2xl:text-[52px] xl:text-[40px] lg:text-[30px] md:text-[30px] text-[25px]  font-bold lg:text-left text-center'>Ready to discuss your</h1>

                <h1 className='2xl:text-[52px] xl:text-[40px] lg:text-[36px] md:text-[30px] text-[25px]  font-bold 2xl:-mt-8 lg:-mt-3 -mt-3 lg:text-left text-center'>content marketing</h1>
                <h1 className='2xl:text-[52px] xl:text-[40px] lg:text-[36px] md:text-[30px] text-[25px]  font-bold 2xl:-mt-8 lg:-mt-3 -mt-3 lg:text-left text-center'>Strategy ?</h1>
              </motion.div>
              ...
              <motion.p
                ...
                animate={readyInView ? { y: 0, opacity: 1.2 } : {}}
                transition={{ duration: 1, delay: 0.3, ease: 'easeOut' }}
                className='text-[#B2AFAF] lg:text-left text-center sm:pt-0 pt-3 lg:mx-0 md:mx-[100px] sm:mx-[50px] mx-[20px]'>Meet with one of our content marketing strategists to take a deep dive into your brand’s goals and objectives. We’ll customize a strategy around your needs and outline our recommended services, budgets, and expectations together.
              </motion.p>
              ...
              <div className="flex justify-center">
                <motion.button
                  ...
                  animate={readyInView ? { y: 0, opacity: 1.2 } : {}}
                  transition={{ duration: 1, delay: 0.4, ease: 'easeOut' }}
                  className=' bg-[#01000B] text-[#F0F0F0] mt-10 px-10 py-3  mb-10 '>Schedule Your Content Strategy Call</motion.button>
              </div>
            </div>
          </div>

          <div className="lg:hidden left_side 2xl:w-[80%] ">
        ...
        <div ref={successRef} className="sucess">
          ...
          <motion.div
            ...
            <h1 className='text-white md:text-[54px] text-[34px] font-bold text-center font-Outfit'>Trusted By Industry Leaders</h1>
          </motion.div>
