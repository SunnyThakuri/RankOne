...
const AboutClient = () => {
  ...
  return (
    <div className="overflow-hidden relative mt-[100px]">
      <motion.div
        className="flex"
        animate={{ x: ["0%", "-100%"] }}
        transition={{
      ...
      >
        {[...images, ...images].map((image, index) => (
          <div key={index} className="flex-shrink-0 border-[2px] border-[#47474747] hover:border-white rounded-[10px] h-[200px] w-[200px]  mx-[10px]" style={{ width: `${100 / images.length}%` }}>
