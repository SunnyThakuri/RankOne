  ...
  return (
    <>
      <div className="Design_Branding text-white">
        <h1 className="text-white text-[22px] ">Digital Marketing/ Ads</h1>

        <div data-aos="fade-left" data-aos-delay="300" className="images mt-5 grid lg:grid-cols-3 grid-cols-2 lg:gap-10 gap-3">
          <div className="">
