  ...
  return (
    <>
      <div className="all bg-black text-white pt-[55px] font-Outfit">
        ...
        <h1 className='text-white md:text-[52px] text-[42px] text-center font-semibold'>Animation Design Course</h1>
        ...
        <div className="future lg:flex lg:justify-between font-Outfit">
          <div className="left-side text-center pt-[79px]">
            ...
            <div className="lg:w-[532px] pt-5 lg:text-left text-center lg:mx-auto md:mx-[100px] sm:mx-[50px] mx-5">
              <p className='text-[#C5C7CC]'>Rank One Camp offers a <span className='text-[#FAFF00]'>four-month-long course</span> in animation design that teaches students how to create animations for various mediums and platforms, including computer graphics, multimedia, and web design.</p>
        ...
        <div className="bg-white my-[62px] pb-[32px]">
          <h1 className='text-black text-[32px] font-bold text-center pt-[64px]'>Syllabus of Animation Design Course</h1>
          ...
          <div className="syllabus  grid md:grid-cols-2 md:gap-20 2xl:px-[112px] xl:px-[80px] lg:px-[40px] md:px-[40px] sm:px-[70px] px-10  my-[62px] md:space-y-0 space-y-10">
            <div className="adobe">
              <h1 className='text-black text-[22px] font-semibold'> Introduction to Animation</h1>

              <ul className='list-disc text-[#5F6D7E] mt-3'>
                <li>Introduction to Animation</li>
                <li>History of Animation</li>
                <li>Principles of Animation</li>
                <li>Overview of Animation Techniques (2D, 3D, Stop-motion, etc.)</li>
                <li>Animation Software Overview (e.g., Adobe Animate, Blender, Maya)</li>
              </ul>
            </div>

            <div className="illustrator">
              <h1 className='text-black text-[22px] font-semibold'>Fundamentals of Design</h1>
              <ul className='list-disc text-[#5F6D7E] mt-3'>
                <li>Elements of Design (line, shape, color, texture, space)</li>
                ...
                <li>Color Theory</li>
                <li>Typography in Animation</li>
              </ul>
            </div>

            <div className="adobe_premeries">
              <h1 className='text-black text-[22px] font-semibold'> Storyboarding and Pre-Production</h1>
              <ul className='list-disc text-[#5F6D7E] mt-3'>
                <li>Concept Development</li>
                <li>Storyboarding Techniques</li>
                <li>Script Writing for Animation</li>
                <li>Character Design and Developmenty</li>
                <li>Background and Environment Design</li>
                <li>Animatics and Timing</li>
              </ul>
            </div>

            <div className="Advanced Animation Techniques">
              <h1 className='text-black text-[22px] font-semibold'>Advanced Animation Techniques</h1>
              <ul className='list-disc text-[#5F6D7E] mt-3'>
                <li>Advanced Character Animation</li>
                <li>Motion Capture and Integration</li>
                <li>Advanced Lighting and Rendering Techniques</li>
                <li>Logo Designs, illustrations, character and environment designs</li>
                <li>Realistic Physics Simulation</li>
                <li>Procedural Animation Techniques</li>
