  ...
  return (
    <>
      <div className="all bg-black text-white pt-[55px] font-Outfit">
        ...
        <h1 className='text-white md:text-[52px] text-[42px] text-center font-semibold'>Ui/Ux Design Course</h1>
        ...
        <div className="bg-white my-[62px] pb-[32px]">
          <h1 className='text-black text-[32px] font-bold text-center pt-[64px]'>Syllabus of Ui Ux Design Course</h1>
